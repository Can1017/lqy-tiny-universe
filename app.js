...
(() => {
  ...
  if (visualBook && bookPrev && bookNext && bookDots && bookCount) {
    ...
    if (PageFlip) {
      ...
      const book = new PageFlip(visualBook, { width: 440, height: 622, size: 'stretch', minWidth: 240, maxWidth: 480, minHeight: 339, maxHeight: 678, showCover: true, maxShadowOpacity: .22, mobileScrollSupport: false, useMouseEvents: true, flippingTime: 980 });
